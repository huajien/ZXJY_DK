                            ...
                            while retry_count < 5:
                                try:
                                    dailyRreportContent = gptReport.gptConfig(
                                        ...
                                        f"{jobTitleReturnData}的工作日报只要一小段60字左右返回一段json数据数据中有 实习项目，实习记录，实习总结。三个不要其他的东西")
                                ...
                                while retry_count < 5:
                                    try:
                                        ...
                                        if weekDataRreportContent['实习项目'] and weekDataRreportContent['实习记录'] and \
                                            ...
                                            data = {
                                                "uid": uid,
                                                "starttime": (datetime.date.today() - datetime.timedelta(days=7)).strftime('%Y-%m-%d'),
                                                "project": dailyDataRreportContent['实习项目'],
                                                "address": user['address'],
                                                "record": dailyDataRreportContent['实习记录'],
                                                "summary": dailyDataRreportContent['实习总结'],
                                ...
                                while retry_count < 5:
                                    try:
                                        ...
                                        if monthlyDataRreportContent['实习项目'] and monthlyDataRreportContent[
                                            ...
                                            data = {
                                                "uid": uid,
                                                "starttime": (datetime.date.today() - datetime.timedelta(days=31)).strftime('%Y-%m-%d'),
                                                "project": dailyDataRreportContent['实习项目'],
                                                "address": user['address'],
                                                "record": dailyDataRreportContent['实习记录'],
                                                "summary": dailyDataRreportContent['实习总结'],
